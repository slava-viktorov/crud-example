...
describe('TokenService', () => {
  ...
  describe('generateTokens', () => {
    it('should generate access and refresh tokens', async () => {
      ...
      jest
        ...
        .mockReturnValueOnce('15m') // JWT_EXPIRATION_TIME_IN_MINUTES
        .mockReturnValueOnce('refresh-secret') // JWT_REFRESH_SECRET
        .mockReturnValueOnce('7d'); // JWT_REFRESH_EXPIRATION_TIME_IN_DAYS
  ...
  describe('hashRefreshToken', () => {
    it('should hash refresh token using SHA-256', async () => {
      ...
      const result = await service.hashRefreshToken(refreshToken);
  ...
  describe('decodeRefreshToken', () => {
    it('should decode refresh token payload', () => {
      const refreshToken = 'refresh-token';
      const payload = { sub: 'user-1', email: 'test@test.com', jti: 'test-uuid' };
  ...
  describe('getRefreshTokenExpiresInMs', () => {
    it('should return refresh token expiration time in milliseconds', () => {
      ...
      expect(configService.get).toHaveBeenCalledWith('JWT_REFRESH_EXPIRATION_TIME_IN_DAYS');
