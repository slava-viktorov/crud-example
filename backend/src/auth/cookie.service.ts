...
export class CookieService {
  ...
  setAuthCookies(res: Response, tokens: JWTTokensPair): void {
    try {
      ...
      const refreshExpirationTime = this.configService.get<string>('JWT_REFRESH_EXPIRATION_TIME_IN_DAYS')!;
      const accessExpirationTime = this.configService.get<string>('JWT_EXPIRATION_TIME_IN_MINUTES')!;
